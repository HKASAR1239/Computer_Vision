...
Aligns a partial cylindrical point cloud using PCA, then extracts
the highest SLICE_HEIGHT meters of it and writes that slice out.

Adapted from extract_body.py :contentReference[oaicite:2]{index=2}:contentReference[oaicite:3]{index=3}
"""
...
from pca import align_point_cloud_to_z_axis  # :contentReference[oaicite:4]{index=4}:contentReference[oaicite:5]{index=5}
